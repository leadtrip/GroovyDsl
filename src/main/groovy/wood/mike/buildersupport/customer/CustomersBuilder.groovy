...
/**
 * A Grails domain like builder that creates a bunch of database objects and persists them removing concern of
 * having to commit in correct order from end user
 */
